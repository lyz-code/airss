...
with open("src/airss/version.py") as fp:
...
setup(
    name="airss",
    version=version,
    description="Intelligent self-hosted content browser",
    author="Lyz",
    author_email="lyz-code-security-advisories@riseup.net",
    license="GNU General Public License v3",
    long_description=readme,
    long_description_content_type="text/markdown",
    url="https://github.com/lyz-code/airss",
    packages=find_packages("src"),
    package_dir={"": "src"},
    package_data={"airss": ["py.typed"]},
    ...
    install_requires=["repository-orm", "feedparser", "tenacity"],
)
